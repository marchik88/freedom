  ...
  $(function () {
    ...
    if ($slickElement.length) {
      ...
      $slickElement.slick({
        ...
        prevArrow:
          '<button type="button" data-role="none" class="slick-prev" aria-label="Previous" tabindex="0" role="button"><i class="ic ic--left"></i></button>',
        nextArrow:
          '<button type="button" data-role="none" class="slick-next" aria-label="Next" tabindex="0" role="button"><i class="ic ic--right"></i></button>',
        responsive: [
          {
            breakpoint: 1600,
            settings: {
